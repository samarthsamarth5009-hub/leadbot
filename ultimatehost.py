# ╔══════════════════════════════════════════╗
# ║   𝐗𝐄𝐑𝐎𝐍 𝐁𝐄𝐀𝐒𝐓 𝐒𝐂𝐑𝐈𝐏𝐓 — 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗘𝗗𝗜𝗧𝗜𝗢𝗡 🔱  ║
...
# ===========================================================
TOKENS = [
    '8909227532:AAGxGXcrrNi858Isygx27LFt03HzNTv8Oqw',  # replace with your bot tokens
]
...
async def hi(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "╭──🔱 𝚇𝚎𝚛𝚘𝚗 𝙱𝚎𝚊𝚜𝚝 𝙿𝚊𝚙𝚊 𝗜𝘀 𝗔𝗹𝗶𝘃𝗲 🔱──╮\n"
        f"🤖 𝗕𝗼𝘁𝘀 𝗔𝗰𝘁𝗶𝘃𝗲 : {len(bots)}\n"
        "⚡ 𝗠𝗮𝘅 𝗦𝗽𝗲𝗲𝗱 𝗠𝗼𝗱𝗲 🚀\n"
        "╰👑 𝐗𝐄𝐑𝐎𝐍 𝐁𝐄𝐀𝐒𝐓 𝐒𝐂𝐑𝐈𝐏𝐓 v3.0──╯"
    )
